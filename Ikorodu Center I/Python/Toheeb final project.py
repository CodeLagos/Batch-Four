#project by Master Akintayo Toheeb
#Email adress(akintayoayomide0762@gmail.com)
print ("Welcome to my python project !!")
print("This is a calculator which only accepts the calculation of two numbers") 
...
while True :
  ...
  if user_input == '+' :
    ...
    print ("To calculate (number 1 % number 2) :")
    mod(int(input("Enter number 1 : ")),int(input("Enter number  2 : ")))
  elif user_input == 'q':
    break
    print ("")
  else:
