...
if display=="A":
    ...
    print("The inputed latitude of location one is: ",latitude1,d, latitude1_degree, "in" ,latitude1_location)
    print("The inputed latitude of location one is: ", latitude2,d, latitude2_degree,"in",latitude2_location)
    print("The inputed longitude is: ",longitude1,d)
    latitude=input("1 for latitude where both locations are north\n2 latitude where both locations\
    ...
    if latitude=="3":
        print("To calculate latitude distance where both are north and south of the equator")
...
if display=="B":
    print("\t This is the Platform is to calculate local time of places world wide:\n ")
    ...
    print("The inputed data for location one is: ",longitude1,d, longitude1_degree, "at" ,t,  location1)
    print("The inputed data for location two is: ",longitude2,d, longitude2_degree, "at" ,time2,  location2)
    
    print("kindly press A or B")
    display=str(input("1 To calculate time east from greenwich meridien \n2 To calculate time west of Greenwich meridien\
